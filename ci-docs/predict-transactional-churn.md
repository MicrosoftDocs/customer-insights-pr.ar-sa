...
> [!TIP]
> جرب البرنامج التعليمي للتنبؤ بحدوث المعاملات باستخدام بيانات نموذجية: [دليل عينة التنبؤ بوقوع المعاملات](sample-guide-predict-transactional-churn.md).
