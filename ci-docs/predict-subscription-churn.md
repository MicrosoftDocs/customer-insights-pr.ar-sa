...
1. يوجد ثلاثة أقسام رئيسية من البيانات في صفحة النتائج:
    ...
    1. **احتمالية الخسارة (عدد العملاء):** مجموعات العملاء وفقًا لمخاطر الخسارة المتوقعة. يمكن أن تساعدك هذه البيانات لاحقا إذا كنت ترغب في إنشاء مقطع من العملاء أصحاب مخاطر خسارة عالية. تساعدك هذه المقاطع في فهم المكان الذي ينبغي فيه عمل فصل لعضوية المقطع.
       > [!div class="mx-imgBorder"]
