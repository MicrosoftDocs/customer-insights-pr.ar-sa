...
2. حدد **جديد** > **مقطع فارغ**.

3. في جزء **المقطع الجديد**، اختر نوع المقطع وأطلق عليه **اسمًا**.

   اختياريًا، أطلق اسم عرض ووصف يساعدك على تعريف المقطع.

4. حدد **التالي** للوصول إلى الصفحة **مُنشئ المقطع** حيث يمكنك تعريف مجموعة. المجموعة هي مجموعة من العملاء.

5. اختر الكيان الذي يتضمن السمة التي تريد وضع المقطع بها.

6. اختر السمة المراد التقسيم وفقًا لها. يمكن أن تحتوي هذه السمة على نوع واحد من أنواع القيم الأربعة: رقمي أو سلسلة أو تاريخ أو منطقي.

7. اختر عامل وقيمة للسمة المحددة.
...
9. حدد **حفظ** لحفظ المقطع. سيتم حفظ المقطع الخاص بك ومعالجته في حالة التحقق من صحة كافة المتطلبات. وإلا، سيتم حفظه كمسودة.

10. قم بتحديد **رجوع إلى الشرائح** للعودة إلى صفحة **المقاطع**.
