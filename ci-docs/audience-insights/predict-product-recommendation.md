...
1. قم بتعيين الحقول الدلالية إلى السمات ضمن كيان محفوظات الشراء، وحدد **التالي**. بالنسبة لأوصاف الحقول، قم بإلقاء نظرة على [المتطلبات الأساسية](#prerequisites).
   > [!div class="mx-imgBorder"]
   > ![قم بتحديد علاقة الكيان.](media/product-recommendation-purchasehistorymapping.PNG "تعرض صفحة محفوظات الشراء سمات دلالية تم تعيينها إلى الحقول في كيان محفوظات الشراء المحدد")
