...
- يمكنك تصدير ما يصل إلى مليون ملف تعريف لكل تصدير إلى Omnisend وقد يستغرق استكمال العملية ما يصل إلى 4 ساعات.
- يقتصر التصدير إلى Omnisend على الشرائح.
- يتوقف عدد ملفات التعريف التي يمكنك تصديرها إلى Omnisend على عقدك مع Omnisend.
