...
**تصدير شرائح في بيئات لحسابات الأعمال (متاجرة عمل-عمل) أو عملاء فرديين (متاجرة عمل-مستهلك)**  
تدعم معظم خيارات التصدير كلا النوعين من البيئات. تصدير الشرائح إلى أنظمة مستهدفة مختلفة له متطلبات محددة. بشكل عام، يحتوي عضو الشريحة، ملف تعريف العميل، على معلومات الاتصال. في حين أن هذا هو الحال عادةً بالنسبة للقطاعات المبنية على العملاء الفرديين (متاجرة عمل-مستهلك)، إلا أنه ليس بالضرورة الحال بالنسبة للقطاعات القائمة على حسابات الأعمال (متاجرة عمل-عمل). 

**بيئات الصادرات الجزئية لحسابات الأعمال (متاجرة عمل-عمل)**  
