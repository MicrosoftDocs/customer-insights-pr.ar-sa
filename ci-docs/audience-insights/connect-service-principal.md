...
يمكنك استخدام كيان الخدمة كي تتمكن من [إضافة نموذج بيانات عامة أو تحريره كمصدر بيانات](connect-common-data-model.md) أو [إنشاء بيئة أو تحديثها](get-started-paid.md) بطريقة آمنة.
