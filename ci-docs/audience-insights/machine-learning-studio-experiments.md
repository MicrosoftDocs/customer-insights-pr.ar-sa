...
سنستخدم سيناريو وهمي لفندق Contoso للنماذج في هذه المقالة. يجمع فندق Contoso البيانات التالية:
...
![مخرجات نموذج التوصية.](media/azure-machine-learning-model-output.png)
