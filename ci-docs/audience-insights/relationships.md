...
تقوم المؤسسات بإنشاء تسلسلات هرمية للحسابات لإدارة الحسابات وعلاقاتها مع بعضها البعض بشكل أفضل. تدعم إمكانية رؤى الجمهور التدرجات الهرمية لحسابات الوالدين والطفل الموجودة بالفعل في بيانات العميل التي تم استيعابها. على سبيل المثال، حسابات من Dynamics 365 Sales. يمكن تكوين هذه التدرجات الهرمية في صفحة **العلاقات** في رؤى الجمهور، ضمن علامة تبويب التدرج الهرمي للحساب.
