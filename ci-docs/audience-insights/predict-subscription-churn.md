...
1. أدخل عدد **الأيام للبحث في المستقبل للتنبؤ بالخسارة لها** لتعيين نافذة للتنبؤ بالخسارة فيها. على سبيل المثال، للتنبؤ بمخاطر خسارة العملاء على مدى الأيام التسعين القادمة لمواءمة جهود الاستبقاء التسويقية. قد يؤدي توقع مخاطر خسارة العملاء لفترات زمنية طويلة أو قصيرة إلى جعل عملية مواجهة العوامل في ملف تعريف مخاطر الخسارة أكثر صعوبة، ولكن ذلك يعتمد على متطلبات أعمالك الخاصة إلى حدٍ كبير. حدد **التالي** للمتابعة.
   >[!TIP]
