...
- بيانات حول أنشطة العملاء (اختيارية):
    ...
    - يتضمن مخطط البيانات الدلالية للأنشطة ما يلي: 
        - المفتاح الأساسي: المعرف الفريد لنشاط
...
1. عيّن **الفترة الزمنية للتنبؤ‬** لتحديد مدى بُعد الفترة المستقبلية التي تريد تنبؤ مدة بقاء العمل لها.    
   ...
   > [!TIP]
   > لتنبؤ مدة بقاء العميل بشكل أدق للفترة التي حددتها، تحتاج إلى فترة مماثلة من البيانات السابقة. على سبيل المثال، إذا كنت ترغب في التنبؤ لفترة ال 12 القادمة، فمن المستحسن أن يكون لديك ما لا يقل عن 18 إلى 24 شهرًا من البيانات السابقة.
...
- **أداء نموذج التدريب**:‏ A أو B أو C هي درجات محتملة. تشير هذه الدرجات إلى أداء التنبؤ، ويمكنها أن تساعدك في اتخاذ القرار باستخدام النتائج المخزنة في كيان الإخراج. حدد **تعرف على هذه النقاط** لتكوين فهم أفضل لمقاييس أداء النموذج الأساسي وكيفية اشتقاق درجات أداء النموذج النهائي.
  ...
  - A عندما تنبأ النموذج بعدد قليل من العملاء من ذوي القيمة العالية مقارنة بالنموذج الأساسي.
  ...
  *قيمة مدة بقاء العميل لكل عميل = متوسط المشتريات الشهرية التي أجراها العميل في نافذة العميل النشط* عدد الأشهر في فترة تنبؤ قيمة مدة بقاء العميل *إجمالي معدل الاستبقاء لجميع العملاء*
