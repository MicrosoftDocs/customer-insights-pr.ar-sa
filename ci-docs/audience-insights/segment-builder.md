...
ms.locfileid: "7494475"
---
# <a name="create-segments"></a>إنشاء شرائح

تعريف عوامل التصفية المعقدة بشأن كيان العميل الموحد والكيانات المرتبطة به. تعمل كل شريحة، بعد المعالجة، على إنشاء مجموعة من سجلات العملاء التي يمكنك تصديرها وتنفيذ إجراء عليها. تُدار الشرائح في صفحة **الشرائح**. يمكنك [إنشاء مقاطع جديدة](#create-a-new-segment) باستخدام [منشئ المقاطع](#segment-builder) أو [إنشاء مقاطع سريعة](#quick-segments) من مناطق أخرى في التطبيق.

## <a name="segment-builder"></a>منشئ المقاطع

توضح الصورة التالية الجوانب المختلفة لمنشئ المقاطع. تُظهر مقطعًا ينتج عنه مجموعة من العملاء. طلب العملاء البضائع في إطار زمني محدد وجمعوا عددًا من نقاط المكافأة أو أنفقوا مبلغًا معينًا من المال. 
...
هناك العديد من الطرق لإنشاء شريحة جديدة. يصف هذا القسم كيفية بناء المقطع الخاص بك من البداية. يمكنك أيضا إنشاء *شريحة سريعة* استنادا إلى الكيانات الموجودة أو استخدام نماذج التعلم الآلي للحصول على *الشرائح المقترحة*. مزيد من المعلومات: [نظرة عامة على الشرائح](segments.md).
...
1. في صفحة منشئ المقاطع، يمكنك تحديد القاعدة الأولى. تتكون القاعدة من شرط واحدة أو أكثر وتحدد مجموعة من العملاء.
...
1. إذا كانت لديك شروط متعددة في القاعدة، يمكنك اختيار عامل التشغيل المنطقي الذي يربط بينها.
   ...
   1. يمكنك إنشاء قواعد متعددة لإنشاء مجموعات مختلفة من سجلات العملاء. يمكنك دمج المجموعات لكي تتضمن العملاء المطلوبين في حالة العمل الخاصة بك. لإنشاء قاعدة جديدة، حدد **إضافة قاعدة**. على وجه التحديد، إذا كنت لا تستطيع تضمين كيان في قاعدة بسبب مسار العلاقة المحدد، فيجب عليك إنشاء قاعدة جديدة لاختيار السمات من القاعدة.
...
1. بشكل افتراضي، تنشئ المقاطع كيان الإخراج الذي يحتوي على جميع سمات ملفات تعريف العملاء التي تطابق عوامل التصفية المحددة. إذا كانت شريحة تستند إلى كيانات أخرى غير كيان *العميل*، فيمكنك إضافة المزيد من السمات من هذه الكيانات إلى كيان الإخراج. حدد **سمات المشروع** لاختيار السمات التي سيتم إلحاقها بكيان الإخراج.  
   ...
   مثال: يعتمد المقطع على كيان يحتوي على بيانات شراء مرتبطة بكيان *العميل*. يبحث هذا المقطع عن جميع العملاء من إسبانيا الذين اشتروا البضائع في العام الحالي. يمكنك اختيار إلحاق سمات مثل سعر البضائع أو تاريخ الشراء بجميع سجلات العملاء المطابقة في كيان الإخراج. قد تكون هذه المعلومات مفيدة لتحليل الارتباطات الموسمية بإجمالي الإنفاق.
   ...
   > - يمكنك فقط عرض السمات من كيان يتم استخدامه في كل قاعدة من استعلام المقطع الذي تقوم بإنشائه.
...
1. حدد **تشغيل** لحفظ ومعالجة مقطعك إذا تم التحقق من صحة جميع المتطلبات. بخلاف ذلك، سيتم حفظه كمسودة مقطع غير نشطة.
...
> - إذا كانت لديك قواعد متعددة لمقطعك، فستجد شريطًا أزرق حول القاعدة التي تقوم بتحريرها.
> - يمكنك نقل القواعد والشروط إلى أماكن أخرى في تعريف المقطع. حدد [...] بجوار قاعدة أو شرط واختر كيفية ومكان نقله.
> - تسمح لك عناصر التحكم في **التراجع** و **الإعادة** في شريط الأوامر بالتراجع عن التغييرات.
