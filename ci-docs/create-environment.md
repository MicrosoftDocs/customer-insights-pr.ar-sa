...
- **الاسم**: اسم لهذه البيئة. يتم ملء هذا الحقل بشكل مسبق إذا قمت بالنسخ من بيئة موجودة، ولكن يمكنك تغييره. إذا كان لديك أكثر من بيئة عمل، فامنح كل بيئة عمل يسهل التعرف عليها.
