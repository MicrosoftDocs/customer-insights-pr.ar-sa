...
انتقل إلى **البيانات** > **إثراء** لـ [تكوين عمليات الإثراء وعرضها](enrichment-hub.md).

لتكوين صلات العلامة التجارية وإثراء SoV، انتقل إلى علامة التبويب **اكتشاف** وحدد **إثراء البيانات الخاصة بي** في الإطار المتجانب **العلامات التجارية**.

لتكوين صلات الاهتمامات وإثراء SoV، انتقل إلى علامة التبويب **اكتشاف** وحدد **إثراء البيانات الخاصة بي** في الإطار المتجانب **الاهتمامات**.
...
حدد **الكيان الذي تم إثراؤه** واختر مجموعة البيانات التي تريد إثرائها ببيانات من Microsoft. يمكنك تحديد كيان العميل لإثراء جميع ملفات تعريف العملاء أو تحديد كيان شريحة لإثراء فقط ملفات تعريف العملاء الموجودة في تلك الشريحة.
...
ستجد مخططًا يحتوي على عدد ملفات تعريف العملاء المخصّصة بمرور الوقت ومعاينات للكيانات المخصّصة. راجع البيانات التي تم إثراؤها عن طريق تحديد **معرفة المزيد** في مخططات **مستوى الصلة** أو **مشاركة الصوت**. تذهب البيانات التي تم إثراؤها للعلامات التجارية إلى كيانات **BrandAffinityFromMicrosoft** و **BrandShareOfVoiceFromMicrosoft**. توجد بيانات الاهتمام في كيانات **InterestAffinityFromMicrosoft** و **InterestShareOfVoiceFromMicrosoft**. كما ستجد هذه الكيانات المدرجة في مجموعه **الإثراء**  في **البيانات** > **الكيانات**.
