---
title: إنشاء شرائح
description: قم بإنشاء قطاعات من العملاء لتجميعهم استنادًا إلى سمات متعددة باستخدام منشئ المقطع أو المقاطع السريعة.
ms.date: 03/25/2022
...
1. حدد **تحرير التفاصيل** إلى جانب القسم "بدون عنوان". قدم اسمًا للمقاطع وقم بتحديث **اسم كيان الإخراج** المقترح للمقاطع. بشكل اختياري، أضف وصفًا و[علامات](work-with-tags-columns.md#manage-tags) إلى الشريحة.
...
> - بعد إنشاء شريحة، تمكّنك بعض الشرائح من [تعقب استخدام الشرائح](segments.md#track-usage-of-a-segment).
...
4. سيوفر لك النظام **حجم مقطع مقدر**. يمكنك اختيار إما إنشاء المقطع الذي قمت بتحديده، أو إعادة زيارته أولاً للحصول على حجم قطعة مختلف.
   ...
   :::image type="content" source="media/quick-segment-name.png" alt-text="اسم وتقدير شريحة سريعة.":::

5. قم بتوفير **اسم** و **اسم كيان الإخراج** لشريحتك. بشكل اختياري، أضف [علامات](work-with-tags-columns.md#manage-tags).
