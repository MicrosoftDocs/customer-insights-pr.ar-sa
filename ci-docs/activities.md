...
1. في خطوة **بيانات النشاط**، أدخل المعلومات التالية:
   ...
   - **المفتاح الأساسي**: حدد الحقل الذي يعرّف السجل بشكل فريد. وينبغي ألا يحتوي على أي قيم متكررة أو قيم فارغة أو قيم مفقودة.
     ...
     > [!NOTE]
     > يجب أن يظل المفتاح الأساسي لكل صف متناسقًا عبر تحديثات مصدر البيانات. إذا تم تحديث المفتاح الأساسي لصف في تحديث مصدر البيانات، فإنه ينشئ تكرارات في كيان نشاط الإخراج. 
