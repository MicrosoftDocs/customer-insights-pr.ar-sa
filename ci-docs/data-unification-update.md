...
1. بعد إجراء التغييرات، حدد خيارك التالي:
   ...
   - [توحيد ملفات تعريف العملاء](#run-updates-to-the-unified-customer-profile) لتشغيل شروط المطابقة وتحديث كيان ملف تعريف العميل الموحد دون التأثير على التبعيات (مثل عمليات الإثراء أو المقاطع أو الإجراءات). لا يتم تشغيل العمليات التابعة، ولكن سيتم تحديثها على النحو [المحدد في جدول التحديث](schedule-refresh.md).
...
1. من صفحة **البيانات** > **توحيد**، حدد:
   ...
   - **توحيد ملفات تعريف العملاء**: تشغيل شروط المطابقة وتحديث كيان ملف تعريف العميل الموحد دون التأثير على التبعيات (مثل عمليات الإثراء أو المقاطع أو الإجراءات). لا يتم تشغيل العمليات التابعة، ولكن سيتم تحديثها على النحو [المحدد في جدول التحديث](schedule-refresh.md).
