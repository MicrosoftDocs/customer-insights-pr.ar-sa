...
1. بعد إجراء التغييرات، حدد خيارك التالي:
   ...
   - [توحيد ملفات تعريف العملاء](#run-updates-to-the-unified-customer-profile) لتشغيل شروط المطابقة وتحديث كيان ملف تعريف العميل الموحد دون التأثير على التبعيات (مثل عمليات الإثراء أو الشرائح أو الإجراءات). لا يتم تشغيل العمليات التابعة، ولكن سيتم تحديثها على النحو [المحدد في جدول التحديث](system.md#schedule-tab).
   - [توحيد ملفات تعريف العملاء والتبعيات](#run-updates-to-the-unified-customer-profile) لتشغيل شروط المطابقة وتحديث كيان ملف تعريف العميل الموحد وجميع التبعيات دون التأثير على التبعيات (مثل عمليات الإثراء أو الشرائح أو الإجراءات). تتم إعادة تشغيل جميع العمليات تلقائيًا.
...
1. من صفحة **البيانات** > **توحيد**، حدد:
   ...
   - **توحيد ملفات تعريف العملاء**: تشغيل شروط المطابقة وتحديث كيان ملف تعريف العميل الموحد دون التأثير على التبعيات (مثل عمليات الإثراء أو الشرائح أو الإجراءات). لا يتم تشغيل العمليات التابعة، ولكن سيتم تحديثها على النحو [المحدد في جدول التحديث](system.md#schedule-tab).
